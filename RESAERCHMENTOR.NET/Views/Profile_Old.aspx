<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile_Old.aspx.cs" Inherits="RESAERCHMENTOR.NET.Views.Profile" %>
...
<%--											<div class="fileupload btn btn-default">
										...
										<div class="profile-info text-center">
											<div class="profile-img-wrap">
												<img runat="server" id="PImage" class="inline-block mb-10" alt="user"/>
<%--                                                <asp:Image class="inline-block mb-10" ImageUrl="dist/img/mock1.jpg" ID="PictureImageA" runat="server" Height="140px" Width="120px" />--%>
												<div class="fileupload btn btn-default">
												<span class="btn-text">edit</span>
                                                    <asp:FileUpload ID="PictureUpload" class="upload" runat="server" TabIndex="40" />
												</div>
											...
											<h5 class="block mt-10 mb-5 weight-500 capitalize-font txt-info">
                                                <asp:Button ID="btnUpload" runat="server" OnClick="btnUpload_Click" CausesValidation="False" CssClass="button" Text="Upload" Width="114px" />
                                                <br />
																	...
																	<div class="follo-body">
                                                                            <%foreach (var item in GetFellowByLoginList()){%>
												        						<div class="follo-data">
                                                                                   ...
                                                                                   <asp:Button ID="FollowB" runat="server" OnClick="Follow_Click" class="btn btn-success pull-right btn-xs fixed-btn" Text ="Follow" CommandArgument = '<%#Eval("passFid")%>' />
                                                                                     <div class="clearfix"></div>
																		        </div>
                                                                                <%}%>
															...
															<div class="panel-wrapper collapse in">
																<div class="panel-body pa-0">
																	<div class="col-sm-12 col-xs-12">
																		<div class="form-wrap">
                                                                            <p>
<%--                                                                                <asp:Image ID="Image1" runat="server" Height="140px" ImageUrl="~/images/UserDefined/defaultImage.png" Width="120px" />--%>
                                                                            </p>
																				<div class="form-body overflow-hide">
																					<div class="form-group">
